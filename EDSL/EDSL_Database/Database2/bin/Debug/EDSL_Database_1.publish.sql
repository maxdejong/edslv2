...
CREATE TABLE [dbo].[Team] (
    [teamID]      INT           NOT NULL,
    [clubPID]     INT           NOT NULL,
    [divisionPID] INT           NULL,
...
GO
PRINT N'Creating unnamed constraint on [dbo].[breakDate]...';


GO
ALTER TABLE [dbo].[breakDate] WITH NOCHECK
    ADD FOREIGN KEY ([seasonID]) REFERENCES [dbo].[Season] ([seasonID]);


GO
PRINT N'Creating unnamed constraint on [dbo].[Club]...';


GO
ALTER TABLE [dbo].[Club] WITH NOCHECK
    ADD FOREIGN KEY ([leagueID]) REFERENCES [dbo].[Leauge] ([leagueID]);
...
GO
ALTER TABLE [dbo].[Club] WITH NOCHECK
    ADD FOREIGN KEY ([pContact]) REFERENCES [dbo].[Contact] ([contactID]);
...
GO
ALTER TABLE [dbo].[Club] WITH NOCHECK
    ADD FOREIGN KEY ([sContact]) REFERENCES [dbo].[Contact] ([contactID]);
...
GO
ALTER TABLE [dbo].[Club] WITH NOCHECK
    ADD FOREIGN KEY ([location]) REFERENCES [dbo].[Location] ([groundID]);


GO
PRINT N'Creating unnamed constraint on [dbo].[Division]...';


GO
ALTER TABLE [dbo].[Division] WITH NOCHECK
    ADD FOREIGN KEY ([leagueID]) REFERENCES [dbo].[Leauge] ([leagueID]);


GO
PRINT N'Creating unnamed constraint on [dbo].[Draw]...';


GO
ALTER TABLE [dbo].[Draw] WITH NOCHECK
    ADD FOREIGN KEY ([seasonID]) REFERENCES [dbo].[Season] ([seasonID]);
...
GO
ALTER TABLE [dbo].[Draw] WITH NOCHECK
    ADD FOREIGN KEY ([divisionID]) REFERENCES [dbo].[Division] ([divisionID]);
...
GO
ALTER TABLE [dbo].[Draw] WITH NOCHECK
    ADD FOREIGN KEY ([finalsDrawPID]) REFERENCES [dbo].[Draw] ([drawID]);


GO
PRINT N'Creating unnamed constraint on [dbo].[Leauge]...';


GO
ALTER TABLE [dbo].[Leauge] WITH NOCHECK
    ADD FOREIGN KEY ([pContact]) REFERENCES [dbo].[Contact] ([contactID]);
...
ALTER TABLE [dbo].[Location] WITH NOCHECK
    ADD FOREIGN KEY ([homeClub]) REFERENCES [dbo].[Club] ([clubID]);


GO
PRINT N'Creating unnamed constraint on [dbo].[Match]...';


GO
ALTER TABLE [dbo].[Match] WITH NOCHECK
    ADD FOREIGN KEY ([roundPID]) REFERENCES [dbo].[Round] ([roundID]);
...
GO
ALTER TABLE [dbo].[Match] WITH NOCHECK
    ADD FOREIGN KEY ([homeTeam]) REFERENCES [dbo].[Team] ([teamID]);
...
GO
ALTER TABLE [dbo].[Match] WITH NOCHECK
    ADD FOREIGN KEY ([awayTeam]) REFERENCES [dbo].[Team] ([teamID]);
...
ALTER TABLE [dbo].[Player] WITH NOCHECK
    ADD FOREIGN KEY ([teamPID]) REFERENCES [dbo].[Team] ([teamID]);
...
GO
ALTER TABLE [dbo].[Player] WITH NOCHECK
    ADD FOREIGN KEY ([eContact]) REFERENCES [dbo].[Contact] ([contactID]);


GO
PRINT N'Creating unnamed constraint on [dbo].[Round]...';


GO
ALTER TABLE [dbo].[Round] WITH NOCHECK
    ADD FOREIGN KEY ([drawPID]) REFERENCES [dbo].[Draw] ([drawID]);


GO
PRINT N'Creating unnamed constraint on [dbo].[Season]...';


GO
ALTER TABLE [dbo].[Season] WITH NOCHECK
    ADD FOREIGN KEY ([leaguePID]) REFERENCES [dbo].[Leauge] ([leagueID]);
...
ALTER TABLE [dbo].[Team] WITH NOCHECK
    ADD FOREIGN KEY ([clubPID]) REFERENCES [dbo].[Club] ([clubID]);
...
GO
ALTER TABLE [dbo].[Team] WITH NOCHECK
    ADD FOREIGN KEY ([divisionPID]) REFERENCES [dbo].[Division] ([divisionID]);
...
GO
ALTER TABLE [dbo].[Team] WITH NOCHECK
    ADD FOREIGN KEY ([contact]) REFERENCES [dbo].[Contact] ([contactID]);
